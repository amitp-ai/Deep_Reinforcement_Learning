...
Double DQN [3] is the implementation of double Q-learning using a deep neural network as the function approximator. Note that it is not a direct implementation of double Q-learning using a deep neural network, it is slightly different in terms of how the two networks are used. Refer to [3] and my Github code for implementation details.
**************************
