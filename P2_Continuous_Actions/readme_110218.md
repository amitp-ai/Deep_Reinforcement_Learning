...
And this is going to be a much better estimate of the expected gradient (Equation 3), i.e. with lower variance and lower bias, even for m=1. As a result, the algorithm will learn much faster.
