...
And thus the Advatange function can now be represented using a single neural network parameterized with w<sub>v</sub>. The gradient equation for Advantage Actor Critic is thus going to be:
